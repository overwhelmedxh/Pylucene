...
def search_para(para_id, parser, searcher):
    ...
    for hit in hits.scoreDocs:
        ...
        para_data["location"] = str("这是" + date + '的第' + a_num + '篇文章的第' + p_num + '段')
...
if __name__ == '__main__':
    result1 = para_search("d20151204040p020")
    result2 = para_search("d20200818119p007")

    result = [result1, result2]
    with open('/root/2para.json', 'w', encoding='utf-8') as fw:
